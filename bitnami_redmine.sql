...
-- Thời gian đã tạo: Th12 25, 2021 lúc 02:29 PM
...
(3, 1, 2, '[Database] [Quản lý thể loại]  Chưa thể xóa thể loại trên database ', 'Mô tả chung: App chưa thể xóa thể loại trên database \r\n\r\nCác bước tái hiện bug: \r\n1. Khi xóa 1 thể loại trên danh sách\r\n2. Thể loại đấy bị xóa trên danh sách giao diện\r\n3. khi khởi động lại chương trình \r\n4. thể loại bị xóa vẫn tồn tại trên danh sách ', NULL, NULL, 1, 8, 3, NULL, 7, 0, '2021-12-25 14:01:48', '2021-12-25 14:01:48', '2021-12-22', 0, NULL, NULL, 3, 1, 2, 0, NULL),
(4, 1, 2, '[Giao diện] [About] layout map bị lệch khung hình ', 'Mô tả chung: layout map bị lệch sang phải so với trung tâm màn hình\r\n\r\nđề xuất: Căn chỉnh trở lại vị trí trung tâm màn hình để dễ trải nghiệm', NULL, NULL, 5, 8, 1, NULL, 7, 1, '2021-12-25 14:05:33', '2021-12-25 14:22:51', '2021-12-25', 0, NULL, NULL, 4, 1, 2, 0, '2021-12-25 21:22:51'),
(5, 1, 2, '[Database] [Quản lý sách]  Chưa thể xóa sách trên database ', 'Mô tả chung: App chưa thể xóa thể sách trên database\r\n\r\nCác bước tái hiện bug:\r\n1. Khi xóa 1 sách trên danh sách\r\n2. Sách đấy bị xóa trên danh sách giao diện\r\n3. khi khởi động lại chương trình\r\n4. Sách bị xóa vẫn tồn tại trên danh sách', NULL, NULL, 2, 7, 3, NULL, 8, 3, '2021-12-25 14:08:35', '2021-12-25 14:26:36', '2021-12-25', 0, NULL, NULL, 5, 1, 2, 0, NULL),
(6, 2, 2, '[Chức năng] [About] Xin xác nhận cuộc gọi trước khi thực hiện cuộc gọi', 'Mô tả chung: Khi muốn thực hiện cuộc gọi cần xin xác nhận thực hiện cuộc gọi\r\n\r\nĐề xuất:\r\n1. Ấn link sđt để gọi \r\n2. hiện dialog xin xác nhận thực hiện\r\n3. ấn xác nhận hoặc từ chối\r\n4. thực hiện cuộc gọi hoặc hủy ', NULL, NULL, 1, 7, 2, NULL, 8, 0, '2021-12-25 14:18:08', '2021-12-25 14:18:08', '2021-12-25', 0, NULL, NULL, 6, 1, 2, 0, NULL);
...
(2, 5, 'Issue', 8, '', '2021-12-25 21:10:31', 0),
(3, 5, 'Issue', 1, '', '2021-12-25 21:21:02', 0),
(4, 4, 'Issue', 1, '', '2021-12-25 21:22:51', 0);
...
(4, 2, 'attr', 'description', 'Mô tả chung: ', 'Mô tả chung: App chưa thể xóa thể sách trên database\r\n\r\nCác bước tái hiện bug:\r\n1. Khi xóa 1 sách trên danh sách\r\n2. Sách đấy bị xóa trên danh sách giao diện\r\n3. khi khởi động lại chương trình\r\n4. Sách bị xóa vẫn tồn tại trên danh sách'),
(5, 3, 'attr', 'status_id', '1', '2'),
(6, 4, 'attr', 'status_id', '1', '5'),
(7, 4, 'attr', 'assigned_to_id', '7', '8');
...
(4, 8, 2, '2021-12-25 13:49:57', 0),
(5, 7, 2, '2021-12-25 13:50:23', 0);
...
(2, 'App quản lý sách', 'App di động quản lý sách đơn giản', '', 1, NULL, '2021-12-25 13:42:59', '2021-12-25 13:42:59', 'app-quan-ly-sach', 1, 1, 2, 0, NULL, NULL);
...
(14, 1, 'session', '2ac1107b427cb118e4c78b9b1611dae1503e618b', '2021-12-25 21:19:03', '2021-12-25 14:26:44');
...
(1, 'huy', '3d299488740f9cb84cd664f142ed4a4a969e14c3', 'Quoc Huy', 'Admin', 1, 1, '2021-12-25 21:19:03', 'en', NULL, '2021-12-23 04:12:30', '2021-12-23 04:12:30', 'User', NULL, 'all', '7e3f54a24c269f3ea24ecd3f7dd4750b', 0, NULL, NULL, NULL, NULL),
